...
description: "Define symbolic functions with scalar and vector inputs, named arguments, composition, and multi-output evaluation in Gradgen."
tags:
  - basics
  - functions
  - symbolic
...
the function
$f:\mathbb{R} \times \mathbb{R} \to \mathbb{R}$ with
...
$f:\mathbb{R}^2 \times \mathbb{R} \to \mathbb{R}$
given by 
...
$g: \mathbb{R}^2 \to \mathbb{R}^2$ given by 
