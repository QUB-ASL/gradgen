...
description: "Register custom elementary functions in Gradgen with Python callbacks, Jacobians, Hessians, and Rust code generation support."
tags:
  - advanced
  - custom-functions
...
**See first:** [Rust code generation](/gradgen/docs/basics/codegen)
...
need to construct a `Function` object (see [above](/gradgen/docs/advanced/custom#registering-custom-functions)).
...
the name of the function we defined [earlier](/gradgen/docs/advanced/custom#registering-custom-functions), 
...
There are cases where you may want to use your own auxiliary 
functions in the auto-generated file, or even use additional 
dependencies in your code. You then need to specify a *header*
as discussed [here](/gradgen/docs/basics/codegen#dependencies).
...
[![Try it In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/15evuEw3zy851kTaE5MpaTZSIs7M08qYo?usp=sharing)
...
the function [`RUST_F`](#custom-rust-implementation) that we 
defined earlier in the [registering custom functions](#registering-custom-functions)
...
code using [`with_additional_dependencies`](/gradgen/docs/basics/codegen#dependencies).
