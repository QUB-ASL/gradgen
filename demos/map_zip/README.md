...
- [`main.py`](./main.py): defines mapped/batched staged functions and generates Rust
...
- evaluate mapped, batched, and composed map+zip functions in Python
- evaluate Jacobians for batched and composed functions in Python
