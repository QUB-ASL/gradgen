...
fn main() {
    ...
    let binary_zip_jac_a_f_metadata = map_zip_kernel_binary_zip_jacobian_a_seq_f_meta();
    ...
    print_metadata("binary_zip_jacobian_a_seq_f metadata", binary_zip_jac_a_f_metadata);
    ...
    let mut binary_zip_jac_a = vec![0.0_f64; binary_zip_jac_a_f_metadata.output_sizes[0]];
    let mut binary_zip_jac_a_work = vec![0.0_f64; binary_zip_jac_a_f_metadata.workspace_size];
    map_zip_kernel_binary_zip_jacobian_a_seq_f(
        &a_seq,
        &b_seq,
        &mut binary_zip_jac_a,
        &mut binary_zip_jac_a_work,
    )
    .unwrap();
    println!(
        "J_binary_zip wrt a_seq from binary_zip_jacobian_a_seq_f = {}",
        format_slice(&binary_zip_jac_a)
    );
}
