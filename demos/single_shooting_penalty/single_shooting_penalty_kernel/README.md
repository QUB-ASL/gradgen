...
- `single_shooting_penalty_kernel_penalized_mpc_cost_f_states`: workspace `8`, inputs `(2, 5, 2, 1)`, outputs `(1, 12)`
- `single_shooting_penalty_kernel_penalized_mpc_cost_grad_states_u_seq`: workspace `14`, inputs `(2, 5, 2, 1)`, outputs `(5, 12)`
- `single_shooting_penalty_kernel_penalized_mpc_cost_hvp_states_u_seq`: workspace `33`, inputs `(2, 5, 2, 1, 5)`, outputs `(5, 12)`
- `single_shooting_penalty_kernel_penalized_mpc_cost_f_grad_states_u_seq`: workspace `15`, inputs `(2, 5, 2, 1)`, outputs `(1, 5, 12)`
...
`../single_shooting_penalty_kernel_python` so the kernels can be imported from
