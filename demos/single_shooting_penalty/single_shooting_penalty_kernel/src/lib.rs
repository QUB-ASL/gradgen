...
/// Return metadata describing [`single_shooting_penalty_kernel_penalized_mpc_cost_f_states`].
...
/// Evaluate the generated symbolic function `single_shooting_penalty_kernel_penalized_mpc_cost_f_states`.
///
...
pub fn single_shooting_penalty_kernel_penalized_mpc_cost_grad_states_u_seq_meta() -> FunctionMetadata
{
    FunctionMetadata {
...
/// Evaluate the generated symbolic function `single_shooting_penalty_kernel_penalized_mpc_cost_grad_states_u_seq`.
///
/// All numeric slices use the `f64` scalar type.
///
/// Arguments:
...
pub fn single_shooting_penalty_kernel_penalized_mpc_cost_hvp_states_u_seq_meta() -> FunctionMetadata
{
    FunctionMetadata {
...
/// Evaluate the generated symbolic function `single_shooting_penalty_kernel_penalized_mpc_cost_hvp_states_u_seq`.
///
/// All numeric slices use the `f64` scalar type.
///
/// Arguments:
...
pub fn single_shooting_penalty_kernel_penalized_mpc_cost_hvp_states_u_seq(
    ...
    for stage_index in 0..5 {
        ...
        single_shooting_penalty_kernel_penalized_mpc_cost_dynamics_jvp(
            current_state,
            u_t,
            p,
            current_tangent,
    ...
    for stage_index in (1..5).rev() {
        ...
        single_shooting_penalty_kernel_penalized_mpc_cost_stage_cost_grad_u_jvp(
            x_t,
            u_t,
            p,
            tangent_x_t,
        ...
        single_shooting_penalty_kernel_penalized_mpc_cost_dynamics_vjp_u_jvp(
            x_t,
            u_t,
            p,
            &lambda_current[..],
        ...
        lambda_next[0] += temp_state[0];
        lambda_next[1] += temp_state[1];
        single_shooting_penalty_kernel_penalized_mpc_cost_stage_cost_grad_x_jvp(
            x_t,
            u_t,
            p,
            tangent_x_t,
        ...
        single_shooting_penalty_kernel_penalized_mpc_cost_dynamics_vjp_x_jvp(
            x_t,
            u_t,
            p,
            &lambda_current[..],
...
pub fn single_shooting_penalty_kernel_penalized_mpc_cost_f_grad_states_u_seq_meta(
) -> FunctionMetadata {
    FunctionMetadata {
...
/// Evaluate the generated symbolic function `single_shooting_penalty_kernel_penalized_mpc_cost_f_grad_states_u_seq`.
///
/// All numeric slices use the `f64` scalar type.
///
/// Arguments:
