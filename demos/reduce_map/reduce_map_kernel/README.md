...
- `reduce_map_kernel_mapped_seq_f`: workspace `2`, inputs `(3,)`, outputs `(3,)`
- `reduce_map_kernel_mapped_seq_jf_x_seq`: workspace `3`, inputs `(3,)`, outputs `(9,)`
- `reduce_map_kernel_reduced_scalar_f`: workspace `4`, inputs `(1, 3)`, outputs `(1,)`
