# squared_distance_to_set_kernel
...
- `squared_distance_to_set_kernel_distance_energy_f`: workspace `1`, inputs `(2,)`, outputs `(1,)`
- `squared_distance_to_set_kernel_distance_energy_grad_x_f`: workspace `1`, inputs `(2,)`, outputs `(2,)`
