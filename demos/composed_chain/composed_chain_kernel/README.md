...
- `composed_chain_kernel_chain_demo_f`: workspace `7`, inputs `(2, 26)`, outputs `(2,)`
- `composed_chain_kernel_chain_demo_grad_x`: workspace `37`, inputs `(2, 26)`, outputs `(4,)`
