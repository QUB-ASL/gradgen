...
# The generated code is at optimizers/inv_pend_benchmark
gradiator = gradgen.CostGradient(x, u, f, ell, vf, N)
gradiator.with_target_path("optimizers").with_name("inv_pend_bm_gradgen").build()
...
#   optimizers/inv_pend_bm_open/icasadi_inv_pend_bm_open/extern/auto_casadi_grad.c
#
# and a Rust wrapper at:
#   optimizers/inv_pend_bm_open/icasadi_inv_pend_bm_open/
#
# Look at:
#   optimizers/inv_pend_bm_open/icasadi_inv_pend_bm_open/src/lib.rs
#
...
meta = og.config.OptimizerMeta().with_optimizer_name("inv_pend_bm_open")
