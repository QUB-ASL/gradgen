...
# Calculation of gradient of VN with respect to u_{N-1}
t=N-1
g_VN_t = []
g_VN_t_cache = []
sum = np.zeros((1, nx))
...
print('nabla_VN_u_N_1',g_VN_t_cache)

# Calculation of gradient of VN with respect to u_{N-2}
t=N-2
g_VN_t = []
g_VN_t_cache = []
sum = np.zeros((1, nx))
...
g_VN_t += jfu_py(xs[:, t], us[:, t], sum)
g_VN_t_cache.extend(g_VN_t)
print('nabla_VN_u_N_2',g_VN_t_cache)

# Calculation of gradient of VN with respect to u_{N-3}
t=N-3
g_VN_t = []
g_VN_t_cache = []
sum = np.zeros((1, nx))
...
g_VN_t += jfu_py(xs[:, t], us[:, t], sum)
g_VN_t_cache.extend(g_VN_t)
print('nabla_VN_u_N_3', g_VN_t_cache)
...
print('Here is the result generated by CasADi')
