...
gradiator.with_target_path("../benchmarks/generated_code").with_name("inv_pend_bm_gradgen").build()
...
build_config = og.config.BuildConfiguration()\
    .with_build_directory("../benchmarks/generated_code").with_tcp_interface_config()
